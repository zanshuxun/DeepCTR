...
behavior_length = pd.read_pickle(input_file + 'din_input_len_' + str(FRAC) + '_' + str(SESS_MAX_LEN) +'.pkl')[0] # TypeError: only integer scalar arrays can be converted to a scalar index # 保存的是个1个元素的list 
