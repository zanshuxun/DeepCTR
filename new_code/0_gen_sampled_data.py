...
if __name__ == "__main__":
    ...
    user = pd.read_csv('../../alimama/user_profile.csv')
    sample = pd.read_csv('../../alimama/raw_sample.csv')
    ...
    if os.path.exists('../raw_data/behavior_log_pv.pkl'):
        ...
        log = pd.read_csv('../../alimama/behavior_log.csv')
    ...
    ad = pd.read_csv('../../alimama/ad_feature.csv')
